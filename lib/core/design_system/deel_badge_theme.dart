...
class DeelBadgeThemeData extends ThemeExtension<DeelBadgeThemeData> {
  ...
  factory DeelBadgeThemeData.light() => const DeelBadgeThemeData(
    ...
    gold: DeelmarktColors.badgeGold,
    unverified: DeelmarktColors.neutral500,
    verifiedBackground: DeelmarktColors.badgeVerifiedBg,
    escrowBackground: DeelmarktColors.badgeEscrowBg,
    goldBackground: DeelmarktColors.badgeGoldBg,
  ...
  factory DeelBadgeThemeData.dark() => const DeelBadgeThemeData(
    ...
    gold: DeelmarktColors.darkBadgeGold,
    unverified: DeelmarktColors.darkOnSurfaceSecondary,
    verifiedBackground: DeelmarktColors.darkBadgeVerifiedBg,
    escrowBackground: DeelmarktColors.darkBadgeEscrowBg,
    goldBackground: DeelmarktColors.darkBadgeGoldBg,
