...
/// Single action tile used by [ActionRequiredSection].
///
/// Displays an icon, title, subtitle, and chevron. Ship-order tiles
/// show an orange left-accent border; reply tiles do not.
///
/// Reference: docs/screens/02-home/designs/seller_mode_home_mobile_light/
class ActionTile extends StatelessWidget {
  const ActionTile({required this.action, required this.onTap, super.key});
